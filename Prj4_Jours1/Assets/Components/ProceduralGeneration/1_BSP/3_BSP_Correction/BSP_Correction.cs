...
[CreateAssetMenu(menuName = "Procedural Generation Method/BSP/BSP_Correction")]
public class BSP_Correction : ProceduralGenerationMethod
{
    ...
    protected override async UniTask ApplyGeneration(CancellationToken cancellationToken)
    {
        ...
        // Create all tree.
        var root = new NodeC(RandomService, this, allGrid);
        Tree.Add(root);
...
public class NodeC
{
    ...
    private NodeC _child1;
    private NodeC _child2;

    public NodeC(RandomService randomService, BSP_Correction bsp2, RectInt room)
    {
    ...
    private void Split()
    {
        ...
        _child1 = new NodeC(_randomService, _bsp2, splitBoundsLeft);
        _child2 = new NodeC(_randomService, _bsp2, splitBoundsRight);
    ...
    private void ConnectNodes(NodeC node1, NodeC node2)
    {
